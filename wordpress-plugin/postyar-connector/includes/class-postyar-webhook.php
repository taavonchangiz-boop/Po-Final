<?php
/**
 * ارسال رویدادهای محصول به وب‌هوک پُست‌یار (جهت افزونه → سرویس).
 *
 * رویدادها:
...
class Postyar_Webhook {
        ...
        /**
         * ارسال واقعی رویداد به وب‌هوک پُست‌یار + ثبت گزارش.
         *
         * @param string               $event_type نوع رویداد.
         ...
         *
         * @param string $api_url   نشانی پایهٔ پُست‌یار (تنظیمات مدیر).
        ...
        public static function send_ping() {
                ...
                if ( ! Postyar_Settings::is_paired() || '' === $settings['postyar_api_url'] ) {
                        return array(
                                'ok'      => false,
                                'code'    => 0,
                                'message' => 'تنظیمات اتصال کامل نیست. نشانی پُست‌یار، شناسهٔ سایت و کلید مخفی را وارد کنید.',
                        );
                }
                ...
                $result = array(
                        ...
                        'code'    => $code,
                        'message' => $ok
                                ? 'اتصال با پُست‌یار برقرار است.'
                                : 'اتصال با پُست‌یار برقرار نشد. تنظیمات و دسترسی شبکه را بررسی کنید.',
                );
