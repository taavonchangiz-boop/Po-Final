...
| 15 | usePageTitle coverage | rg all page components | **PASS** — every route page sets a Persian title (Overview, Publishing, Scheduling, Channels, Bots, BotDetail, Workflows, AI, Gold, Woo, Analytics, Wallet, Subscription, Referrals, Support, Settings, Notifications, Admin ×4, Landing, guards); suffix «| پُست‌یار» |
